 ...
 */
final class Version20201001163010 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fc_category (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, created_at DATETIME NOT NULL, topic CLOB NOT NULL, CONSTRAINT FK_27B31AEBF675F31B FOREIGN KEY (author_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__fc_category AS SELECT id, author_id, topic, created_at FROM fc_category');
        $this->addSql('DROP TABLE fc_category');
        $this->addSql('CREATE TABLE fc_category (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, author_id INTEGER NOT NULL, created_at DATETIME NOT NULL, topic VARCHAR(255) NOT NULL COLLATE BINARY)');
        $this->addSql('INSERT INTO fc_category (id, author_id, topic, created_at) SELECT id, author_id, topic, created_at FROM __temp__fc_category');
        $this->addSql('DROP TABLE __temp__fc_category');
        $this->addSql('CREATE INDEX IDX_27B31AEBF675F31B ON fc_category (author_id)');
    }
